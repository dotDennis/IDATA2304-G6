 ...
 * 
 * <p>When ON, this actuator could increase the LIGHT sensor readings
 * to simulate lux values (lighting) in the greenhouse.
 */
public class LightSwitchActuator extends Actuator {

  /**
   * Constructs a LightSwitchActuator with the specified device ID.
   * 
   * @param deviceId unique identifier for the light switch actuator
   */
